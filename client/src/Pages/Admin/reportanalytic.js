...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        const checkNewReports = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/auth/new-report`, { params });
        ...
        const fetchReportsLast28Days = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/auth/getreport28days`, { params });
        ...
        const fetchEventViews = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/auth/event-views`, { params });
